                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tr>
                      <th scope="row">{{$showbiayaoperationalproyek->kode_biaya_operational_proyek}}</th>
                        ...
                        <td>
                          <a href="/detailbiayaoperationalproyeka/{{$showbiayaoperationalproyek->kode_biaya_operational_proyek}}" ><button class="btn btn-info" data-target="#edit" data-toggle="modal">lihat detil</button></a>
